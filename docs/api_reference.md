...
### Triggers & Simulation (Including Local Dev)
...
- `POST /api/triggers/simulate-spoofing`
- `POST /api/triggers/social-trigger`
...
### Notifications
- `GET /api/notifications/worker/{worker_id}`
- `POST /api/notifications/worker/{worker_id}/mark-read`
