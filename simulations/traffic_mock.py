...
class TrafficSimulator:
    ...
    def get_traffic(self, zone: str) -> dict:
        ...
        return {
            ...
            "average_speed_kmh": round(max(5, 40 * (1 - congestion)), 1),
            "delay_minutes": round(congestion * 30, 1),
            "incidents": random.randint(0, 3) if congestion > 0.5 else 0,
